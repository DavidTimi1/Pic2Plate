...
const Navbar: React.FC = () => {
    return (
        <nav className="shadow-md fixed w-full top-0 z-10 left-0 bg-background p-0">
            <div className="container mx-auto px-8 py-6 flex justify-between items-center text-xl">
